...
SCRIPTPATH=/home/neuro/Documents/Scripts/local # Where the python & perl scripts for Annovar or other general scripts are
...
perl $AnnovarPATH/annotate_variation.pl -regionanno -buildver $BUILD -dbtype bed -bedfile ID_gene_list_Dec18.bed $AV_INPUT $AV_DB >> $1.pipeline.log 2>&1
...
rm $AV_INPUT.$BUILD.bed_new $AV_INPUT.$BUILD\_bed
perl $AnnovarPATH/annotate_variation.pl -regionanno -buildver $BUILD -dbtype DDG2P --colsWanted 5,6,7,8,10 $AV_INPUT $AV_DB >> $1.pipeline.log 2>&1
